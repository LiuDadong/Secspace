...
; (function ($w) {
    ...
    // core object
    var om = function (use, opts) {
        om.current = this;
        this.version = __version__;
        //default jsmind opts
        var __def__ = {
            container: '',          //'jsmind_container'-- id of the container   
            relBtnContainer:'',     //'#orgmind_btns'
        ...
        if (!__def__.relBtnContainer) {
            logger.error('relBtnContainer should not be null or empty.');
            return;
        }
        this.opts = deepMerge({},__def__);
        this.jm = new jsMind(this.opts);
        this.jminner = $('#' + opts.container).find('.jsmind-inner');
        this.jmnodes = jminner.find('jmnodes');
        this.inited = false;
        this.init();
    ...
    om.prototype = {
        init: function () {
            ...
            this.inited = true;
            var jm =this.jm;
            var jminner =this.jminner;
            var jmnodes =this.jmnodes;
            if(this.opts.relBtnContainer&&this.opts.editable){
                
                jmEditInit();
                function jmEditInit() {
                    var jmbtncnt = $(opts.relBtnContainer);
        ...
        getMind:function(cb) {  //获取机构树mind数据刷新至页面，cb支持回调
            var that=this;
        ...
        showMind:function(cb){
            var that=this;
            if(that.mind)
            that.getMind(function(mind){
                that.jm.show({
