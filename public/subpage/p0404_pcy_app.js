...
$.silentGet('/man/apppolicy/appList', { platform: 'android' }, function (data) {
    if (data.rt == '0000') {
        selAppList.html('');
...
$.silentGet('/man/apppolicy/onBlackList', {}, function (data) {
    if (data.rt == '0000') {
...
function add_policy() {
    ...
    if (postData) {
        $.actPost('/man/apppolicy/add_policy', postData, function (data) {
            if (data.rt == '0000') {
                pagingTable.PagingTable('update');
            }
        });
...
function mod_policy() {
    ...
    if (postData) {
        ...
        $.actPost('/man/apppolicy/mod_policy', postData, function (data) {
            if (data.rt == '0000') {
                pagingTable.PagingTable('update');
            }
        }, '修改并下发');
